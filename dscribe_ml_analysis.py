...
r_whole = np.load(f"{root_dir}/DATASETS/r.npy")
r_train_full = np.load(f"{root_dir}/DATASETS/r_train_full.npy")
order = np.argsort(r_whole)
E_whole = np.load(f"{root_dir}/DATASETS/E.npy")
E_train_full = np.load(f"{root_dir}/DATASETS/E_train_full.npy")
E_whole_pred = np.load(f"{root_dir}/DATASETS/E_whole_pred.npy")
F_whole = np.load(f"{root_dir}/DATASETS/F.npy")
F_train_full = np.load(f"{root_dir}/DATASETS/F_train_full.npy")
F_whole_pred = np.load(f"{root_dir}/DATASETS/F_whole_pred.npy")
